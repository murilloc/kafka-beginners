...
public class ConsumerDemoInsideConsumerGroup {


    public static final Logger log = LoggerFactory.getLogger(ConsumerDemoInsideConsumerGroup.class.getSimpleName());
